...
def _build_template(
    ...
    repo_name = f"nexus-n3-algorithm-{plugin_id}"

    package = package_name or f"nexus_n3_algorithm_{plugin_id.replace('-', '_')}"
...
Standalone Nexus N3 algorithm plugin for `{template.algorithm_name}`.
...
version = "0.1.0"
description = "{template.display_name} algorithm plugin for Nexus N3 OS"
readme = "README.md"
...
[project.entry-points."nexus_n3.algorithms"]
